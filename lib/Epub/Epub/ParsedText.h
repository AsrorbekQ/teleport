...
class ParsedText {
  ...
  bool isNaturalAlign;
  bool hasRtlWord;
  // Set once the first layout pass of this paragraph has emitted lines. A long block is
  // soft-flushed in chunks through repeated layoutAndExtractLines() calls, and every chunk
  // starts again at break index 0 -- without this the first-line indent is re-applied in the
